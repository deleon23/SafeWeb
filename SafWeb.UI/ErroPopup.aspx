<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ErroPopup.aspx.vb" Inherits="FrameWork.UI.ErroPopup"%>
	...
	<body >
		<form id="Form2" method="post" runat="server">
			<table cellspacing="0" cellpadding="0" width="779" align="center" border="0">
				...
				<tr>
					<td>
						<cc1:FWServerControl id="Fwservercontrol4" runat="server" Controle="Rodape"
