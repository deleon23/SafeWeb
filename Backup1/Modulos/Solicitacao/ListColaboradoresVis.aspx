<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListColaboradoresVis.aspx.cs" Inherits="SafWeb.UI.Modulos.Solicitacao.ListColaboradoresVis" %>
...
<body>
    <form id="form" method="post" runat="server">
        <table class="MarginTopConteudo" cellspacing="0" cellpadding="0" width="500px" border="0">
            ...
            <tr>
                <td>
                    <asp:TextBox ID="txtNome" runat="server" Width="300px" CssClass="cadtxt"
                        AutoPostBack="True"></asp:TextBox>
                        <asp:TextBox ID="hdTipo" runat="server" CssClass="hiddencol"/>
                </td>
                <td>
                    <cc1:FWMascara ID="txtDocumento" runat="server" CssClass="cadtxt" Mascara="NENHUMA"
                        MaxLength="9" Width="99px" AutoPostBack="True"></cc1:FWMascara></td>
                <td style="width: 51px">
                ...
                <td colspan="3">
                    ...
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                        ...
                        <SelectParameters>
                            ...
                            <asp:FormParameter name="pTipo" formfield="hdTipo" />
