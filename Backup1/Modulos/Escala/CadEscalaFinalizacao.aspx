<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CadEscalaFinalizacao.aspx.cs"
    Inherits="SafWeb.UI.Modulos.Escala.CadEscalaFinalizacao" %>
                    ...
                    <table class="MarginTopBarra" cellspacing="0" cellpadding="0" width="760" align="center"
                        ...
                        <tr>
                            <td class="cadBarraTitulo" align="left" style="height: 25px; width: 750px">
                                ...
                                <asp:Label ID="Label2" runat="server" Text="Lançamento de Escalas - Finalização - Período:"></asp:Label>
                                <asp:Label ID="txtPeriodo" runat="server" />
                            </td>
                        ...
                        <tr>
                            <td class="backboxconteudo" valign="top" style="height: 250px" colspan="2">
                                ...
                                <table class="MarginTopConteudo" cellspacing="0" cellpadding="0" width="740" align="center"
                                    border="0">
                                    <%--<tr>
                                        <td class="cadlbl" align="right" style="padding-top: 0px;" width="100px" colspan="2">
                                            <asp:Label ID="Label1" runat="server" Text="Período:"></asp:Label>
                                        </td>
                                    </tr>--%>
                                    <tr>
                                        <%--<td width="100px" align="left" style="padding-bottom: 10px;">
                                            <asp:Label ID="txtPeriodo" runat="server" Width="200px">
                                            </asp:Label>
                                        </td>--%>
                                        <td class="cadmsg">
                                        ...
                                        <td style="padding-top: 10px; padding-bottom: 5px;">
                                            <table class="MarginTopConteudo" cellspacing="0" cellpadding="0" width="740" align="center"
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="cadlbl" align="right" style="padding-top: 0px;" width="520px" colspan="2">
                                                        <asp:Label ID="lblDataBusca" runat="server" Text="Data:"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td width="100px" align="left" style="padding-bottom: 0px;" colspan="2">
                                                        <asp:TextBox ID="txtNomeColaborador" runat="server" CssClass="cadddl" Width="150px">
                                                        </asp:TextBox>
                                                    </td>
                                                    <td width="150px" align="left" style="padding-bottom: 0px;">
                                                        <asp:DropDownList ID="ddlDatas" runat="server" CssClass="cadddl" Width="150px">
                                                        </asp:DropDownList>
                                                    </td>
                                                    <td align="left" style="padding-bottom: 10px;">
                                                        <asp:Button ID="btnFiltrarData" runat="server" CssClass="cadbutton100" Text="Filtrar"
                                                            OnClick="btnFiltrarData_Click" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="center" colspan="4">
                                                        ...
                                                        <rad:RadGrid ID="radGridHorariosColaboradores" runat="server" AllowPaging="True"
                                                            AllowSorting="True" AutoGenerateColumns="False" SortingSettings-SortToolTip="Clique para filtrar"
                                                            CssClass="dtg" GridLines="None" Skin="None" Width="100%" Height="250px" OnNeedDataSource="radGridHorariosColaboradores_NeedDataSource"
                                                            ...
                                                            <MasterTableView>
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <rad:GridBoundColumn DataField="CodLegado" SortExpression="CodLegado" UniqueName="CodLegado"
                                                                        Visible="false">
                                                                    </rad:GridBoundColumn>
                                                                    <rad:GridBoundColumn DataField="HorarioColaborador" SortExpression="HorarioColaborador"
                                                                        UniqueName="HorarioColaborador" Visible="false">
                                                                    </rad:GridBoundColumn>
                                                                    ...
                                                                    <rad:GridTemplateColumn UniqueName="TemplateColumn" Visible="true">
                                                                        <ItemStyle HorizontalAlign="Center" Width="5%"></ItemStyle>
                                                                        <ItemTemplate>
                                                                            <asp:Image ID="IMGStatus" runat="server" ImageUrl="%%PATH%%/imagens/icones/ico_Ativo.gif">
                                                                            </asp:Image>
                                                                        </ItemTemplate>
                                                                    </rad:GridTemplateColumn>
                                                                </Columns>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="520px" align="left" colspan="2" style="padding-left: 95px;">
                                                        <%--<asp:Button ID="btnEditarData" runat="server" CssClass="cadbutton100" Text="Editar esta data"
                                                            OnClick="btnEditarData_Click" />--%>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="cadlbl" width="520" align="right" colspan="2">
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="150px">
                                                        <asp:DropDownList ID="ddlAprovadores" runat="server" CssClass="cadddl" Width="150px">
                                                        </asp:DropDownList>
                                                    </td>
                                                    <td style="padding-left: 20px;" width="370px">
                                                        <asp:Button ID="btnEnviarAprovacao" runat="server" CssClass="cadbutton100left" Text="Enviar Aprovação"
                                                            OnClick="btnEnviarAprovacao_Click" />
