...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="AcessoAdm.aspx.vb" Inherits="FrameWork.UI.AcessoAdm" %>
	...
	<body >
		<form id="Form2" method="post" runat="server">
			<table cellspacing="0" cellpadding="0" width="778" align="center" border="0" >
									...
									<table class="MarginTopBarra" width="740" border="0" cellspacing="0" cellpadding="0" align="center">
										<tr>
											...
											<td class="cadBarraTitulo" height="15" width="720">
												...
												<asp:Label id="lblTitulo" runat="server">Erro de Permissão de Acesso</asp:Label>
											</td>
										...
										<tr>
											...
											<td align="center" valign="top" colspan="3">
												<table class="ContainerBordaLRB" cellspacing="0" cellpadding="5" width="100%" border="0" align="center">
													...
													<tr>
														<td class="cadlblForm" align="center"><asp:Label id="lblMensagem" runat="server">Usuário não tem permissão</asp:Label>
														</td>
													</tr>
													<tr>
														<td height="100">&nbsp;</td>
				...
				<tr>
					<td>
						<cc1:FWServerControl id="Fwservercontrol2" runat="server" Controle="RodapeAdmin"></cc1:FWServerControl></td>
				</tr>
			</table>
		</form>
	</body>
