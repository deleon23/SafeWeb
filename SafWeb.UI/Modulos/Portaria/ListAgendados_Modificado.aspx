<%@ Page Language="C#" AutoEventWireup="true" Codebehind="ListAgendados_Modificado.aspx.cs"
                                                                            ...
                                                                            <td>
                                                                                <table style="border-right: #cccccc 1px solid; border-top: #cccccc 1px solid; padding: 5px;
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="cadlbl" width="240">
                                                                                            <asp:Label ID="lblRE_Conting" runat="server" Text="RE:"></asp:Label></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="txtNomeColaborador_Conting" runat="server" CssClass="cadtxt" MaxLength="50"
                                                                                    ...
                                                                                    <asp:ImageButton ID="btnListarColaborador_Conting"
                                                                                        ...
                                                                                        OnClick="btnListarColaborador_Conting_Click" ValidationGroup="Contingencia" />
                                                                            </td>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class="cadlbl">
                                                                                            <asp:Label ID="lblMotivoLiberacao_Conting" runat="server" Text="Motivo da Liberação:"></asp:Label></td>
                                                                                        <td style="height: 20px; width: 5px;">
                                                                                        </td>
                                                                                        <td class="cadlbl">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class="cadlbl" colspan="3">
                                                                                            <br />
                                                                                            <asp:Label ID="lblDadosAporvador_Conting" runat="server" Text="Dados Aprovador"></asp:Label>
                                                                                            <table style="border: 1px solid black" width="740">
                                                                                                <tr>
                                                                                                    <td class="cadlbl" width="500">
                                                                                                        <asp:Label ID="lblAprovador_Conting" runat="server" Text="Aprovador:"></asp:Label>
                                                                                                    </td>
                                                                                                    <td style="height: 20px; width: 5px;">
                                                                                                    </td>
                                                                                                    <td class="cadlbl">
                                                                                                        <asp:Label ID="lblREAprovador_Conting" runat="server" Text="RE:"></asp:Label>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td>
                                                                                                        <asp:DropDownList ID="ddlAprovador_Conting" runat="server" CssClass="cadddl" Width="449px"
                                                                                                            Enabled="False" AutoPostBack="True" OnSelectedIndexChanged="ddlAprovador_Conting_SelectedIndexChanged">
                                                                                                        </asp:DropDownList>
                                                                                                        <asp:RequiredFieldValidator ID="rfvAprovador" runat="server" ControlToValidate="ddlAprovador_Conting"
                                                                                                            ErrorMessage="Campo Obrigatório: Aprovador." InitialValue="0" ValidationGroup="Contingencia">*</asp:RequiredFieldValidator></td>
                                                                                                    <td style="height: 20px; width: 5px;">
                                                                                                    </td>
                                                                                                    <td>
                                                                                            ...
                                                                                            <table align="center" border="0" cellpadding="0" cellspacing="0" width="740">
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td align="right" class="backBarraBotoes">
                                                                                                        &nbsp;<asp:Button ID="btnGravarContingencia" runat="server" CssClass="cadbutton100" Text="Liberar Acesso"
