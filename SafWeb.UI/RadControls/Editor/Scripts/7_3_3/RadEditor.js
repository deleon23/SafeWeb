...
var _76=new RegExp("(href|src)\\s*=\\s*('|\")?(.+?)(\\2)([^<]*?>)","ig");
var _77=function(_78,g1,g2,g3,g4,g5,_7e,_7f){
if(!g2){
g2="";
g3=g3+g5;
var _80=g3.match(/(\s|>)/gi);
if(_80){
var _81=_80.index;
g5=g3.substring(_81,g3.length);
g3=g3.substring(0,_81);
}else{
return _78;
}
}
...
_75=_75.replace(_76,_77);
var _82=new RegExp("(<!--[\\s\\S]*?) originalAttribute=\"(href|src)\" originalPath=\"[^\"]+\"([\\s\\S]*?-->)","ig");
_75=_75.replace(_82,"$1$3");
return _75;
...
RadEditorNamespace.IECleanAnchorsFilter.prototype={GetHtmlContent:function(_5f){
var _60=document.location.href;
var re=new RegExp("(<A[^<>]*?(href)\\s*=\\s*['\"])("+_60+")(\\#[^'\"]*?['\"][^>]*?>)","ig");
var _62=_5f.replace(re,"$1$4");
return _62;
}};
...
RadEditorNamespace.MozEmStrongFilter.prototype={GetHtmlContent:function(_63){
var _64=_63.replace(new RegExp("<b(\\s([^>])*?)?>","ig"),"<strong$1>");
_64=_64.replace(new RegExp("</b(\\s([^>])*?)?>","ig"),"</strong$1>");
_64=_64.replace(new RegExp("<i(\\s([^>])*?)?>","ig"),"<em$1>");
_64=_64.replace(new RegExp("</i(\\s([^>])*?)?>","ig"),"</em$1>");
return _64;
},GetDesignContent:function(_65){
var _66=_65.replace(new RegExp("<strong(\\s([^>])*?)?>","ig"),"<b$1>");
_66=_66.replace(new RegExp("</strong(\\s([^>])*?)?>","ig"),"</b$1>");
_66=_66.replace(new RegExp("<em(\\s([^>])*?)?>","ig"),"<i$1>");
_66=_66.replace(new RegExp("</em(\\s([^>])*?)?>","ig"),"</i$1>");
return _66;
}};
...
RadEditorNamespace.MozillaKeepStylesString.prototype={GetDesignContent:function(_67){
var _68=this;
var _69=function(_6a,_6b,_6c,_6d,_6e){
var _6f=_6e.indexOf("</head>",_6d);
if(_6f!=-1&&_6e.indexOf("<body",_6f)!=-1){
return _6a;
}else{
_68.markerCounter++;
var _70="RadEditorStyleKeeper"+_68.markerCounter;
var _71="<div id='"+_70+"' style='display:none;'>&nbsp;</div><"+_6b+" reoriginalpositionmarker='"+_70+"'"+_6c;
return _71;
}
};
var _72=new RegExp("<(link|style)([^>]*>)","gi");
var _73=_67.replace(_72,_69);
return _73;
}};
...
RadEditorNamespace.MozillaKeepStylesDom.prototype={GetHtmlContent:function(_74){
var _75=_74.getElementsByTagName("HEAD")[0];
var _76=true;
if(!_75){
_75=_74.ownerDocument.getElementsByTagName("HEAD")[0];
_76=false;
}
if(!_75){
return _74;
}
this._restoreElements(_75,_74,"STYLE");
this._restoreElements(_75,_74,"LINK");
var _77=_74.getElementsByTagName("DIV");
if(_77){
for(var j=_77.length-1;j>=0;j--){
var _79=_77[j];
if(_79.id.indexOf("RadEditorStyleKeeper")==0){
...
_77=null;
if(_76){
this._removeElements(_75,"STYLE");
this._removeElements(_75,"LINK");
}
this._removeMarkerAttributes(_74,"STYLE");
this._removeMarkerAttributes(_74,"LINK");
return _74;
},_restoreElements:function(_7b,_7c,_7d){
var _7e;
_7e=_7b.getElementsByTagName(_7d);
this._divs=_7c.getElementsByTagName("DIV");
var i=0;
while(_7e.length>0&&i<_7e.length){
this._restoreStyle(_7e[i++]);
}
},_restoreStyle:function(_80){
var _81=_80.getAttribute("reoriginalpositionmarker");
if(_81){
j=0;
var _82=null;
while(j<this._divs.length&&!_82){
if(this._divs[j].id==_81){
_82=this._divs[j];
}
j++;
}
if(_82){
var _83=_80.cloneNode(true);
_83.removeAttribute("reoriginalpositionmarker");
var _84=_82.parentNode;
_84.replaceChild(_83,_82);
return true;
}
}
return false;
},_removeElements:function(_85,_86){
var _87=_85.getElementsByTagName(_86);
if(_87){
for(var j=_87.length-1;j>=0;j--){
var _89=_87[j];
if(null!=_89.getAttribute("reoriginalpositionmarker")){
var _8a=_89.parentNode;
_8a.removeChild(_89);
}
}
_87=null;
}
},_removeMarkerAttributes:function(_8b,_8c){
styles=_8b.getElementsByTagName(_8c);
if(styles){
...
RadEditorNamespace.MozillaKeepFlashString=function(_8e){
this.IsDom=false;
this.Enabled=true;
...
this._flashImageSrc=_8e?_8e:"FlashManager.gif";
};
RadEditorNamespace.MozillaKeepFlashString.prototype={GetDesignContent:function(_8f){
var _90=this;
var _91=function(_92,gr1,gr2,gr3,str,_97){
var _98="<img isflash=\"true\" "+gr1+" />"+gr2;
_98=_98.replace(/\ssrc=/gi," src=\""+_90._flashImageSrc+"\" flashSrc=");
return _98;
};
var _99=new RegExp("<embed([^>]*)?>(.*)?(<\\/embed>)?","ig");
var _9a=_8f.replace(_99,_91);
return _9a;
}};
...
RadEditorNamespace.MozillaKeepFlash.prototype={GetHtmlContent:function(_9b){
if(!_9b){
return _9b;
}
var _9c=_9b.getElementsByTagName("IMG");
for(var i=0;i<_9c.length;i++){
var _9e=_9c[i];
var _9f=_9e.getAttribute("isflash");
if(_9f!=null){
var _a0=_9e.getAttribute("flashSrc");
var _a1=RadEditorNamespace.Utils.GetOuterHtml(_9e);
_a1=_a1.replace(/<img/gi,"<embed");
var _a2=_9e.ownerDocument.createElement("DIV");
_a2.innerHTML=_a1;
newNode=_a2.firstChild;
if(_a0){
newNode.src=_a0;
if(window.RadControlsNamespace.Browser.IsSafari){
newNode.setAttribute("src",_a0);
}
}
newNode.removeAttribute("flashSrc");
newNode.removeAttribute("isflash");
var _a3=_9e.parentNode;
_a3.insertBefore(newNode,_9e);
_a3.removeChild(_9e);
i--;
}
}
...
RadEditorNamespace.StripJunkFilter.prototype={GetHtmlContent:function(_a4){
var _a5=_a4;
if(window.RadControlsNamespace.Browser.IsSafari){
_a5=_a5.replace(new RegExp(" class=\"khtml-block-placeholder\"","ig"),"");
_a5=_a5.replace(new RegExp(" class=\"Apple-style-span\"","ig"),"");
_a5=_a5.replace(new RegExp(" class=\"webkit-block-placeholder\"","ig"),"");
}
if(window.RadControlsNamespace.Browser.IsFirefox){
_a5=_a5.replace(new RegExp("\\s?<br type=\"_moz\" \\/>","ig")," ");
_a5=_a5.replace(new RegExp(" _moz_[a-z_]*=\"[^\"]*\"","ig"),"");
_a5=_a5.replace(new RegExp(" type=\"_moz\"","ig"),"");
}
return _a5;
}};
...
},GetHtmlContent:function(_a7){
var _a8=_a7.ownerDocument;
var _a9=_a8.createElement("SPAN");
var _aa,_ab,_ac;
var _ad=_a7.getElementsByTagName("FONT");
while(_ad.length>0){
_ab=_ad[0];
_ac=_ab.parentNode;
_aa=_a9.cloneNode(false);
RadEditorNamespace.Utils.MergeElementAttributes(_ab,_aa,false);
if(_ab.style.cssText&&_ab.style.cssText!=""){
_aa.style.cssText=_ab.style.cssText;
}
if(_ab.className){
_aa.className=_ab.className;
}
if(_ab.face){
_aa.style.fontFamily=_ab.face;
}
var _ae=0;
if(_ab.style.fontSize){
_aa.style.fontSize=_ab.style.fontSize;
}else{
if(!isNaN(_ae=parseInt(_ab.size))&&_ab.size!="+0"){
try{
if(_ae<0){
_ae=_ae+4;
}
_aa.style.fontSize=this._fontSizes[_ae-1];
}
catch(ex){
_aa.style.fontSize=this._fontSizes[3];
}
}
}
if(_ab.color){
_aa.style.color=_ab.color;
}
if(window.RadControlsNamespace.Browser.IsIE&&_ab.innerHTML==" "){
_aa.innerText=_ab.innerHTML;
}else{
RadEditorNamespace.Utils.setElementInnerHtml(_aa,_ab.innerHTML);
}
_ac.replaceChild(_aa,_ab);
_ad=_a7.getElementsByTagName("FONT");
}
return _a7;
},GetDesignContent:function(_af){
var _b0=_af.ownerDocument;
var _b1=_b0.createElement("FONT");
var _b2,_b3,_b4;
var _b5=_af.getElementsByTagName("SPAN");
while(_b5.length>0){
_b2=_b5[0];
_b4=_b2.parentNode;
_b3=_b1.cloneNode(false);
RadEditorNamespace.Utils.MergeElementAttributes(_b2,_b3,false);
if(_b2.style.cssText&&_b2.style.cssText!=""){
_b3.style.cssText=_b2.style.cssText;
}
if(_b2.className){
_b3.className=_b2.className;
}
if(_b2.style.fontFamily){
_b3.face=_b2.style.fontFamily;
if(window.RadControlsNamespace.Browser.IsIE){
_b3.style.removeAttribute("fontFamily");
}else{
_b3.style.fontFamily=null;
}
}
if(_b2.style.fontSize){
var _b6=3;
var _b7=this._fontSizesRev[parseInt(_b2.style.fontSize)];
if(typeof (_b7)!="undefined"){
_b3.size=_b7+1;
this._removeElementStyleAttribute(_b3,"fontSize");
}
}
if(_b2.style.color){
if(window.RadControlsNamespace.Browser.IsIE){
_b3.color=_b2.style.color;
_b3.style.removeAttribute("color");
}
}
if(window.RadControlsNamespace.Browser.IsIE&&_b2.innerHTML==" "){
_b3.innerText=_b2.innerHTML;
}else{
RadEditorNamespace.Utils.setElementInnerHtml(_b3,_b2.innerHTML);
}
_b4.replaceChild(_b3,_b2);
_b5=_af.getElementsByTagName("SPAN");
}
return _af;
},_removeElementStyleAttribute:function(_b8,_b9){
if(_b8.style&&_b8.style[_b9]){
_b8.style[_b9]=null;
if(_b8.style.removeAttribute){
_b8.style.removeAttribute(_b9);
}
if(_b8.style.cssText){
}else{
_b8.removeAttribute("style");
}
}
}};
...
},GetHtmlContent:function(_ba){
if(!_ba){
return "";
}
var sb=new RadEditorNamespace.Utils.StringBuilder("");
this._appendNodeXhtml(_ba,sb);
return sb.ToString();
},_convertAttribute:function(s){
return String(s).replace(/\&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\"/g,"&quot;");
},_getAttributeValue:function(_bd,_be,sb){
var _c0=_bd.nodeName;
var _c1=_bd.nodeValue;
if(window.RadControlsNamespace.Browser.IsIE&&(_c0=="type"||_c0=="value"||_c0=="selected")){
if(!_c1){
return;
}
}else{
...
if(!isNaN(_c1)){
_c1=_be.getAttribute(_c0);
}
if(window.RadControlsNamespace.Browser.IsIE&&(_c0=="href"||_c0=="src")){
_c1=_be.getAttribute(_c0,2);
}
sb.Append(" "+(_bd.expando?_c0:_c0.toLowerCase())+"=\""+this._convertAttribute(_c1)+"\"");
}else{
var _c3=_be.style.cssText;
if(_c3){
sb.Append(" style=\""+this._convertAttribute(_c3.toLowerCase())+"\"");
}
}
},_canHaveChildren:function(_c4){
...
return true;
},_appendElementNode:function(_c5,sb){
if(_c5.tagName.charAt(0)=="/"){
return;
}
if(_c5.nodeName=="!"){
sb.Append(_c5.text);
...
var _c7=_c5.nodeName;
if(_c5.scopeName){
if(_c5.scopeName=="HTML"){
_c7=_c7.toLowerCase();
}else{
_c7=_c5.scopeName+":"+_c7;
}
}else{
_c7=_c7.toLowerCase();
}
...
if(window.RadControlsNamespace.Browser.IsIE){
if("img"==_c7){
var _c8=document.createElement("IMG");
_c8.mergeAttributes(_c5);
if(_c8.width){
sb.Append(" width=\""+_c5.getAttribute("width",2)+"\"");
}
if(_c8.height){
sb.Append(" height=\""+_c5.getAttribute("height",2)+"\"");
}
if(_c8.getAttribute("alt").length==0){
sb.Append(" alt=\""+_c8.getAttribute("alt")+"\"");
}
}else{
if("area"==_c7||"a"==_c7){
if(_c5.shape){
sb.Append(" shape=\""+_c5.shape.toLowerCase()+"\"");
}
if(_c5.coords){
sb.Append(" coords=\""+_c5.getAttribute("coords")+"\"");
}
if(_c5.href){
var _c9=_c5.getAttribute("href",2).replace("about:blank","");
_c9=_c9.replace("about:","");
_c9=_c9.replace(/&amp;/gi,"&").replace(/&/gi,"&amp;");
sb.Append(" href=\""+_c9+"\"");
_c5.removeAttribute("href",0);
}
}
}
}
try{
var _ca=_c5.attributes;
var l=_ca.length;
for(var i=0;i<l;i++){
this._getAttributeValue(_ca[i],_c5,sb);
}
}
catch(exc){
}
switch(_c7){
case "script":
sb.Append(">"+_c5.text+"</"+_c7+">");
break;
case "textarea":
sb.Append(">"+_c5.value+"</"+_c7+">");
break;
case "iframe":
sb.Append("></iframe>");
break;
...
if(window.RadControlsNamespace.Browser.IsIE){
_cd=_cd.replace(/\soriginalAttribute="[^"]+"/gi,"");
_cd=_cd.replace(/\soriginalPath="[^"]+"/gi,"");
}
sb.Append(_cd);
sb.Append("</object>");
break;
...
case "comment":
case "noscript":
var _cd=_c5.innerHTML;
if(window.RadControlsNamespace.Browser.IsIE&&_cd.length==0){
_cd=_c5.ownerDocument.title;
}
sb.Append(">"+_cd+"</"+_c7+">");
break;
default:
if(_c5.hasChildNodes()||(true==_c5.canHaveChildren||(_c5.canHaveChildren==null&&this._canHaveChildren(_c5)))){
sb.Append(">");
var cs=_c5.childNodes;
l=cs.length;
for(var i=0;i<l;i++){
...
},_appendTextNode:function(_cf,sb){
var _d1=String(_cf.nodeValue);
var _d2=_cf.parentNode.nodeName.toLowerCase();
if(!window.RadControlsNamespace.Browser.IsIE&&(_d2=="style"||_d2=="script")){
sb.Append(_d1);
}else{
_d1=_d1.replace(/\&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");
if(window.RadControlsNamespace.Browser.IsFirefox){
_d1=_d1.replace(/[\u00a0]/g,"&nbsp;");
}
sb.Append(_d1);
}
},_appendCDataNode:function(_d3,sb){
sb.Append("<![CDA"+"TA[\n"+_d3.nodeValue+"\n]"+"]>");
},_appendCommentNode:function(_d5,sb){
var _d7=_d5.nodeValue;
if(!_d7&&_d5.text){
_d7=_d5.text;
}else{
_d7="<!--"+_d7+"-->";
...
sb.Append(_d7);
},_appendNodeXhtml:function(_d8,sb){
if(_d8.uniqueID){
if(this._uniqueIds[_d8.uniqueID]){
return;
}else{
this._uniqueIds[_d8.uniqueID]=true;
}
}
switch(_d8.nodeType){
case 1:
this._appendElementNode(_d8,sb);
break;
case 3:
this._appendTextNode(_d8,sb);
break;
case 4:
this._appendCDataNode(_d8,sb);
break;
case 8:
this._appendCommentNode(_d8,sb);
break;
}
}};
...
var _da="P|DIV|H1|H2|H3|H4|H5|H6|ADDRESS|PRE|OL|UL|LI|TITLE|META|LINK|BASE|SCRIPT|LINK|TD|TH|AREA|OPTION";
var _db="HTML|HEAD|BODY|STYLE|FORM|TABLE|TBODY|THEAD|TR";
var _dc=_db+"|UL|OL";
this._ignoreTags=new RegExp("(<PRE[^>]*>|<!--|<SCRIPT[^>]*>)([\\s\\S]*?)(<\\/PRE>|-->|<\\/SCRIPT>)","gi");
this._tagsNLBefore=new RegExp("<("+_da+")[^>]*>","gi");
this._tagsNLAfter=new RegExp("<\\/("+_da+")[^>]*>","gi");
this._tagsNLNoCloseAfter=new RegExp("<(BR|HR)[^>]*\\/?>","gi");
this._tagsNLBeforeAndAfter=new RegExp("<\\/?("+_db+")[^>]*>","gi");
this._tagsIncIndent=new RegExp("^<("+_dc+")[\\s\\/>]","i");
this._tagsDecIndent=new RegExp("^<\\/("+_dc+")[\\s\\>]","i");
this._shrinkNL=new RegExp("\\s*\\n+\\s*","gi");
};
RadEditorNamespace.IndentHTMLContentFilter.prototype={dispose:function(){
this._protectedData=[];
},GetHtmlContent:function(_dd){
var _de=RadEditorNamespace.Utils.Trim(_dd);
if(_de.indexOf("<body")==0){
_de=_de.substring(_de.indexOf(">")+1,_de.length-7);
}
this._protectedData=[];
var _df=this;
var _e0=function(_e1,_e2,_e3,_e4,_e5,_e6){
_df._protectedData[_df._protectedData.length]=_e3;
return _e2+"RADEDITORFORMATTED_"+_df._protectedData.length+_e4;
};
_de=_de.replace(this._ignoreTags,_e0);
var _e7="$&";
if(window.RadControlsNamespace.Browser.IsSafari){
_e7="$0";
}
_de=_de.replace(this._tagsNLBefore,"\n"+_e7);
_de=_de.replace(this._tagsNLAfter,_e7+"\n");
_de=_de.replace(this._tagsNLNoCloseAfter,_e7+"\n");
_de=_de.replace(this._tagsNLBeforeAndAfter,"\n"+_e7+"\n");
var _e8=_de.split(this._shrinkNL);
var _e9=new RadEditorNamespace.Utils.StringBuilder("");
var _ea="";
...
if(this._tagsDecIndent.test(_ec)){
if(_ea.length>this._indentPattern.length){
_ea=_ea.substring(this._indentPattern.length);
}else{
_ea="";
}
}
...
_e9.Append(_ec);
_e9.Append("\n");
if(this._tagsIncIndent.test(_ec)){
_ea+=this._indentPattern;
}
}
_de=_e9.ToString();
for(var i=0;i<this._protectedData.length;i++){
var _ed=new RegExp("RADEDITORFORMATTED_"+(i+1));
_de=_de.replace(_ed,this._protectedData[i]);
}
return _de;
}};
RadEditorNamespace.MakePathsAbsolute=function(_ee){
this.IsDom=true;
this.Enabled=true;
...
RadEditorNamespace.MakePathsAbsolute.prototype={GetHtmlContent:function(_ef){
if("href"==this.attrName){
this._updateElements(_ef,"A","href");
this._updateElements(_ef,"AREA","href");
}else{
if("src"==this.attrName){
this._updateElements(_ef,"IMG","src");
this._updateElements(_ef,"EMBED","src");
}
}
return _ef;
},_getElements:function(_f0,_f1){
var _f2=_f0.getElementsByTagName(_f1);
if(!_f2){
_f2=_f0.ownerDocument.getElementsByTagName(_f1);
}
return _f2;
},_updateElements:function(_f3,_f4,_f5){
var _f6=_f3.ownerDocument.createElement("div");
var _f7=this._getElements(_f3,_f4);
if(_f7){
for(var i=0;i<_f7.length;i++){
if("href"==_f5&&_f7[i].getAttribute("href",2)){
_f6.innerHTML="<a href=\""+_f7[i].getAttribute("href",2).replace(/\"/gi,"%22")+"\">test</a>";
_f7[i].setAttribute("href",_f6.childNodes[0].href);
}else{
if("src"==_f5&&_f7[i].getAttribute("src",2)){
_f6.innerHTML="<img src=\""+_f7[i].getAttribute("src",2).replace(/\"/gi,"%22")+"\" />";
_f7[i].setAttribute("src",_f6.childNodes[0].src);
}
}
}
}
...
RadEditorNamespace.RadStripPathFilter=function(_f9,_fa){
this.Name="RadStripPathFilter";
this.Description="This filter strips an image or an anchor path";
this.TagName=_f9;
this.PathToStrip=_fa;
this.GetHtmlContent=function(_fb){
if(!document.all){
return _fb;
}else{
var _fc=StripAbsolutePaths(_fb,this.TagName,this.PathToStrip);
return _fc;
}
return _fb;
};
function StripAbsolutePaths(_fd,_fe,_ff){
var _100=function(_101,_102,_103,_104){
_104=RadEditorNamespace.Utils.EscapeRegexSpecialChars(_104);
var _105=new RegExp("(<"+_102+"[^<>]*?("+_103+")\\s*=\\s*['\"])("+_104+")([^'\"]*?['\"][^>]*?>)","ig");
return _101.replace(_105,"$1$4");
};
var _106=function(_107,_108,_109){
if(_108=="A"){
var _10a=document.location.href;
_10a=RadEditorNamespace.Utils.EscapeRegexSpecialChars(_10a);
var re=new RegExp("(<A[^<>]*?(href)\\s*=\\s*['\"])("+_10a+")(\\#[^'\"]*?['\"][^>]*?>)","ig");
_107=_107.replace(re,"$1$4");
}
var _10c=_107;
var _10d=(_108=="A"?"href":"src");
for(var i=0;i<_109.length;i++){
if(_109[i]){
_10c=_100(_10c,_108,_10d,_109[i]);
}
}
return _10c;
};
...
var _110=window.location;
_10f[0]=_110.protocol+"//"+_110.host+(_110.port?":"+_110.port:"");
var _111=_110.pathname;
var _112=_111.lastIndexOf("/");
if(_112>-1){
_10f[1]=_111.substr(0,_112+1);
}
}
return _106(_fd,_fe,_10f);
}
...
var oDoc=document;
var _197=oDoc.createElement("table");
_197.cellSpacing=2;
_197.cellPadding=0;
_197.className="RadEModuleTable";
_197.style.width="100%";
_197.style.backgroundColor="#ffffcc";
_197.style.borderBottom="1px solid #adadad";
_197.insertRow(-1);
var _198=_197.rows[0].insertCell(-1);
_198.style.width="100%";
var oBut=oDoc.createElement("button");
oBut.className="RadEXhtmlButton";
_198=_197.rows[0].insertCell(-1);
...
_198.appendChild(this.FinishButton);
_198=_197.rows[0].insertCell(-1);
...
_198.appendChild(this.CancelButton);
this.TopElement=_197;
};
...
var _19a=this.Editor.CommandsManager;
var _19b=_19a.Commands;
_19a.RemoveCommandAt(_19b.length-1);
...
AjaxSpellCheckController.prototype.AddCustomWord=function(_19c){
var _19d=this.GetSpellService();
var _19e=this;
var _19f=this.AddWordSuccessMessage;
_19d.AddCustomWord(_19c,function(_1a0,_1a1){
alert(_19c+" "+_19f);
_19e.SpellEngineUI_Instance.ClearWrongWords(_19c,_19c);
},null);
};
AjaxSpellCheckController.prototype.SetVisible=function(_1a2){
this.TopElement.style.display=_1a2?"":"none";
};
AjaxSpellCheckController.prototype.EnableButtons=function(_1a3){
var buts=this.TopElement.getElementsByTagName("button");
for(var i=0;i<buts.length;i++){
buts[i].disabled=!_1a3;
}
};
AjaxSpellCheckController.prototype.SetLoadingIconVisible=function(_1a6){
var _1a7=this.TopElement.rows[0].cells[0];
_1a7.innerHTML="";
if(_1a6){
var oImg=document.createElement("IMG");
oImg.src=this.LoadingIcon;
oImg.align="absmiddle";
_1a7.innerHTML="<label class='RadEToolText'>"+this.SpellingInProgressMessage+"</label>";
_1a7.appendChild(oImg);
}else{
_1a7.innerHTML="<label class='RadEToolText'>"+this.SpellingModeMessage+"</label>";
}
};
AjaxSpellCheckController.prototype.BeginSpellcheck=function(_1a9){
this.SetLoadingIconVisible(false);
this.EnableButtons(true);
if(_1a9.BadWords.length==0){
alert(this.NoSpellingMistakesMessage);
this.FinishSpellcheck();
}else{
this.SpellEngineUI_Instance.Initialize(_1a9,this.OriginalHtml);
}
};
AjaxSpellCheckController.prototype.MakeSpellcheckRequest=function(){
var _1aa=this;
if(this.SpellEngineUI_Instance){
var _1ab=this.SpellEngineUI_Instance.SpellcheckComplete;
if(!_1ab){
this.FinishSpellcheck();
}
}else{
...
_1aa.FinishSpellcheck();
alert(_1aa.CompleteMessage);
};
this.SpellEngineUI_Instance.OnRaiseAddCustomWord=function(_1ac){
_1aa.AddCustomWord(_1ac);
};
}
...
var _1ad=this.GetSpellService();
var _1ae=function(_1af,_1b0){
_1aa.BeginSpellcheck(_1b0);
};
_1ad.SpellCheck(this.SpellEngineUI_Instance.EscapeNewLines(this.OriginalHtml),_1ae,null);
};
if(!_190.AjaxSpellController_Instance){
_190.AjaxSpellController_Instance=new AjaxSpellCheckController(_190);
var _1b1=_190.AjaxSpellController_Instance.TopElement;
if(!_1b1.parentNode||!_1b1.parentNode.tagName){
if(_190.IsIE){
_190.DockingZones.TopZone.appendChild(_1b1);
}else{
_190.ContentAreaElement.parentNode.insertBefore(_1b1,_190.ContentAreaElement);
}
}
}
...
RadEditorCommandList[RadEditorNamespace.RADCOMMAND_SPELLCHECK]=function(_1b2,_1b3,_1b4){
var _1b5=_1b3.GetSelection();
var _1b6=_1b5.GetText();
var _1b7=(""==_1b6||null==_1b6);
var _1b8={restorePoint:_1b3.CreateRestorePoint(),GetText:function(){
return this.getText();
},SetText:function(text){
this.setText(text);
},getText:function(){
if(_1b7){
return _1b3.GetHtml(true);
}else{
return _1b5.GetHtmlText();
}
},setText:function(text){
if(_1b7){
_1b3.SetHtml(text,(_1b3.Localization["CorrectSpelling"]||"Spelling Changes"));
}else{
this.restorePoint.Select();
_1b3.PasteHtml(text,(_1b3.Localization["CorrectSpelling"]||"Spelling Changes"));
}
}};
var _1bb=(_1b4&&_1b4.GetSelectedValue);
var _1bc=_1bb?_1b4.GetSelectedValue():_1b3.Language.replace(/_/,"-");
var _1bd=_1b3.SpellId;
try{
var _1be=GetRadSpell(_1bd);
_1be.Skin=_1b3.SkinBasePath;
_1be.UseClassicDialogs=_1b3.UseClassicDialogs;
if(_1be.Language=="RadEditor_Default"||_1bb){
_1be.Language=_1bc;
}
if(_1be.DictionaryLanguage=="RadEditor_Default"||_1bb){
_1be.DictionaryLanguage=_1bc;
}
_1be.SetTextSource(_1b8);
_1be.StartSpellCheck();
}
catch(spellError){
...
RadEditorNamespace.Utils.setElementInnerHtml(this.Editor.Document.body,this.UnEscapeNewLines(_54.GetResult()));
};
