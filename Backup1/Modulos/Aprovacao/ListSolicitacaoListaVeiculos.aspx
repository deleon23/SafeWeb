<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListSolicitacaoListaVeiculos.aspx.cs"
    Inherits="SafWeb.UI.Modulos.Aprovacao.ListSolicitacaoListaVeiculos" %>
        ...
        <tr>
            <td colspan="3">
                ...
                &nbsp;<rad:RadGrid ID="radGridColaborador" runat="server" AllowPaging="false" AllowSorting="false"
                    ...
                    Width="100%" OnItemDataBound="radGridColaborador_ItemDataBound">
                    ...
                    <MasterTableView>
                        ...
                        <Columns>
                            <rad:GridBoundColumn DataField="Estado" HeaderText="Estado" SortExpression="Estado"
                                UniqueName="Estado">
                                <ItemStyle Width="100px" HorizontalAlign="Left"></ItemStyle>
                                <HeaderStyle Width="100px" HorizontalAlign="Left" />
                            </rad:GridBoundColumn>
                            <rad:GridBoundColumn DataField="Des_Placa" HeaderText="Placa" SortExpression="Des_Placa"
                                UniqueName="Des_Placa">
                                <ItemStyle Width="150px" HorizontalAlign="Left"></ItemStyle>
                                <HeaderStyle Width="100px" HorizontalAlign="Left" />
                            </rad:GridBoundColumn>
                            <rad:GridBoundColumn DataField="Empresa" HeaderText="Empresa" SortExpression="Empresa"
                                UniqueName="Empresa">
