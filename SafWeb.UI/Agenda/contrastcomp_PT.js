...
var gBegin=[1900,01,01];	// calendar date range begin from [Year,Month,Date]. Using gToday here will make it start from today.
var gEnd=[2100,12,31];	// calendar date range end at [Year,Month,Date]
var gsOutOfRange="Data menor que a atual";	// out-of-date-range error message. If set to "", no alerts will popup on such error.
...
var gsNavPrev="<IMG id='navPrev' class='MonthNav' src='arrowl.gif' width='25' height='20' border='0' alt='' onmousedown='showPrevMon()' onmouseup='stopShowMon()' onmouseout='stopShowMon();if(this.blur)this.blur()'>";	// the content of the left month navigator
var gsNavNext="<IMG id='navNext' class='MonthNav' src='arrowr.gif' width='25' height='20' border='0' alt='' onmousedown='showNextMon()' onmouseup='stopShowMon()' onmouseout='stopShowMon();if(this.blur)this.blur()'>";	// the content of the right month navigator

var gbHideBottom=true;
var gsBottom=(NN4?"":"<DIV class='BottomDiv'>")+"<A class='BottomAnchor' href='javascript:void(0)' onclick='if(this.blur)this.blur();fClearSelected();return false;' onmouseover='return true;'>Limpar Datas</A>"+(NN4?"":"</DIV>");
var gbHideHoje=false;
var gsBottomHoje=(NN4?"":"<DIV class='BottomDiv'>")+"<A class='BottomAnchor' href='javascript:void(0)' onclick='if(this.blur)this.blur();if(!fSetDate(gToday[0],gToday[1],gToday[2]))alert(\"Você não selecionou o dia de hoje!\");return false;' onmouseover='return true;' >Hoje : "+gToday[2]+" "+gMonths[gToday[1]-1]+", "+gToday[0]+"</A>"+(NN4?"":"</DIV>");	// the content of the bottom section.


var giCellWidth=25;	// calendar cell width;
var giCellHeight=14;	// calendar cell height;
var giHeadHeight=16;	// calendar head row height;
var giWeekWidth=25;	// calendar week-number-column width;
...
var gcSatBG="#cccccc";	// Saturday background color
var gcSun="black";	// Sunday font color
var gcSunBG="#cccccc";	// Sunday background color
...
var gcToggle="#dadada";	// the highlight color for the focused cell
