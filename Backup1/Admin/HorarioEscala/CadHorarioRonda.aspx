<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CadHorarioRonda.aspx.cs"
    Inherits="SafWeb.UI.Admin.Horarios.CadHorarioRonda" %>
                        ...
                        <asp:Panel runat="server" ID="pnlListagem">
                            ...
                            <table class="MarginTopBarra" cellspacing="0" cellpadding="0" width="760" align="center"
                                ...
                                <tr>
                                    ...
                                    <asp:Label ID="Label1" runat="server" Text="Listagem de horários - Ronda"></asp:Label>
                                    </td>
                                ...
                                <tr>
                                    <td class="backboxconteudo" valign="top" colspan="2">
                                        ...
                                        <table class="MarginTopConteudo" cellspacing="0" cellpadding="0" width="740" align="center"
                                            border="0">                                            
                                        <%--<tr>
                                            <td class="cadlbl" style="width: 100px">
                                                &nbsp;
                                            </td>
                                            ...
                                            <tr>
                                            <td class="cadlbl" style="width: 113px">
                                            ...
                                            <td class="cadlbl" style="width: 230px">
                                                ...
                                                <td class="cadlbl">
                                                    <asp:Label ID="lblCodigoEscalaList" runat="server" Text="Código Horário:"></asp:Label>
                                                </td>
                                            </tr>                                     
                                            <tr>
                                                <td class="cadlbl">
                                                <asp:DropDownList ID="ddlJornada" runat="server" class="cadddl" Style="width: 100px">
                                                </asp:DropDownList>
                                                </td>                            
                                            <td class="cadlbl">
                                                <asp:TextBox ID="txtDescricaoList" runat="server" MaxLength="50" Width="217px" CssClass="cadtxt" />
                                            </td>
                                                <td class="style1">
                                                    <cc1:FWMascara ID="txtCodEscalaList" runat="server" CssClass="cadtxt" Mascara="NUMERO"
                                                        MaxLength="5" Width="75px"></cc1:FWMascara>
                                                </td>                          
                                            </tr>
                                            <tr>
                                                <td colspan="2">
                                    ...
                                    <table class="MarginTopConteudo" cellspacing="0" cellpadding="0" width="740" align="center"
                                        border="0">
                                            <tr>
                                                <td align="center" colspan="3">
                                                    ...
                                                    CssClass="dtg" GridLines="None" Skin="None" Width="100%" OnItemCommand="radGridHorarios_ItemCommand"
                                                    OnItemDataBound="radGridHorarios_ItemDataBound" OnNeedDataSource="radGridHorarios_NeedDataSource">
                                                        ...
                                                        <MasterTableView>
                                                            ...
                                                            <Columns>                                                                
                                                            <rad:GridBoundColumn DataField="IdEscala" SortExpression="IdEscala" UniqueName="IdEscala"
                                                                Visible="false">
                                                                    <ItemStyle Width="5%"></ItemStyle>
                                                                </rad:GridBoundColumn>
                                                                <rad:GridBoundColumn DataField="CodLegado" HeaderText="Cód. Horário" SortExpression="CodLegado"
                                                            ...
                                                            <rad:GridBoundColumn DataField="DesJornada" HeaderText="Jornada" SortExpression="DesJornada"
                                                                UniqueName="DesJornada" Visible="true">
                                                                <ItemStyle Width="5%"></ItemStyle>
                                                                <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                                            </rad:GridBoundColumn>
                                                                <rad:GridBoundColumn DataField="DesEscala" HeaderText="Descrição do Horário" SortExpression="DesEscala"
                                        ...
                                        <table cellspacing="0" cellpadding="0" width="760" align="center" border="0">
                                            ...
                                            <tr>
                                                ...
                                                <asp:Button ID="btnIncluir" runat="server" Text="Novo" CssClass="cadbutton100" OnClick="btnIncluir_Click">
                                                </asp:Button>
                                                </td>
                                            </tr>
                                        </table>
                        ...
                        <asp:Panel runat="server" ID="pnlCadastro" Visible="false">                           
                            ...
                            <table class="MarginTopBarra" cellspacing="0" cellpadding="0" width="760" align="center"
                                ...
                                <tr>
                                    <td class="cadBarraTitulo" align="left" style="height: 25px; width: 750px">
                                        <img src="../../Imagens/comum/bulletbarra.gif" align="absMiddle">
                                    <asp:Label ID="Label6" runat="server" Text="Cadastro de horários- Ronda"></asp:Label>
                                    </td>
                                    <td class="cadBarraTitulo" align="right" height="25" style="width: 9px">
                                        ...
                                        <table class="MarginTopConteudo" cellspacing="0" cellpadding="0" width="740" align="center"
                                            ...
                                            <tr>
                                                <td class="cadmsg" colspan="3">
                                                    <asp:ValidationSummary ValidationGroup="Cadastro" ID="ValidationSummary1" runat="server"
                                            ...
                                            <tr>
                                                <td class="cadlbl">
                                                    <asp:Label ID="Label8" runat="server" Text="Jornada:"></asp:Label>
                                                </td>
                                                <td class="cadlbl">
                                                ...
                                                <td class="cadlbl">
                                                    <asp:Label ID="lblCodHorarioCad" runat="server" Text="Cód. Horário"></asp:Label>
                                                </td>
                                            </tr>                                     
                                            <tr>
                                                <td class="cadlbl">
                                                    <asp:DropDownList ID="ddlJornadaCad" runat="server" class="cadddl" Style="width: 100px">
                                                    </asp:DropDownList>
                                                    <asp:RangeValidator ID="rvlJornada" MinimumValue="1" MaximumValue="9999" runat="server"
                                                        ValidationGroup="Cadastro" SetFocusOnError="True" ControlToValidate="ddlJornadaCad"
                                                        ErrorMessage="Campo Obrigatório: Jornada">*</asp:RangeValidator>
                                                </td>                            
                                                <td class="cadlbl">
                                                    <asp:TextBox ID="txtDescricaoCad" runat="server" MaxLength="30" Width="217px" CssClass="cadtxt" />
                                                    <asp:RequiredFieldValidator ID="frvDescricao" runat="server" ValidationGroup="Cadastro"
                                                        ControlToValidate="txtDescricaoCad" ErrorMessage="Campo Obrigatório: Descrição"
                                                        SetFocusOnError="True">*</asp:RequiredFieldValidator>
                                                </td>
                                                <td class="cadlbl">
                                                    <cc1:FWMascara ID="txtHorarioCad" runat="server" Width="99px" CssClass="cadtxt" MaxLength="4"
                                                        Mascara="HORA">
                                                    </cc1:FWMascara>
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="- Campo Horário: Formato Inválido"
                                                        ControlToValidate="txtHorarioCad" ValidationExpression="^([0-1][0-9]|[2][0-3]):[0-5][0-9]$">*
                                                    </asp:RegularExpressionValidator>
                                                    <asp:RequiredFieldValidator ID="frvHorario" runat="server" ValidationGroup="Cadastro"
                                                        ControlToValidate="txtHorarioCad" ErrorMessage="Campo Obrigatório: Horário" SetFocusOnError="True">*</asp:RequiredFieldValidator>
                                                </td>                            
                                                <td class="cadlbl">
                                                ...
                                                <asp:RequiredFieldValidator ID="frvCodEscala" runat="server" ControlToValidate="txtCodEscalaCad"
                                                        ValidationGroup="Cadastro" ErrorMessage="Campo Obrigatório: Código da Escala"
                                                        SetFocusOnError="True">*</asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td align="center" colspan="4">
                                                    ...
                                                    <rad:RadGrid ID="radGridHorarioLegadoRonda" runat="server" AllowPaging="True" AllowSorting="True"
                                                        AutoGenerateColumns="false" SortingSettings-SortToolTip="Clique para filtrar"
                                                        CssClass="dtg" GridLines="None" Skin="None" Width="100%" Visible="false" OnItemCommand="radGridHorarioLegadoRonda_ItemCommand"
                                                        OnItemDataBound="radGridHorarioLegadoRonda_ItemDataBound" OnNeedDataSource="radGridHorarioLegadoRonda_NeedDataSource">
                                                        <GroupHeaderItemStyle CssClass="dtgGroupHeader"></GroupHeaderItemStyle>
                                                        <GroupPanel Text="">
                                                            <PanelStyle CssClass="dtgGroupPanel"></PanelStyle>
                                                            <PanelItemsStyle CssClass="dtgGroupPanelItem"></PanelItemsStyle>
                                                        ...
                                                        <MasterTableView>
                                                            ...
                                                            <Columns>                                                                
                                                                <rad:GridBoundColumn DataField="CodHor" SortExpression="CodHor" HeaderText="Cód. Horário"
                                                                    UniqueName="CodHor" Visible="true">
                                                                    <ItemStyle Width="50%"></ItemStyle>
                                                                    <HeaderStyle HorizontalAlign="Left" />
                                                                </rad:GridBoundColumn>
                                                                <rad:GridBoundColumn DataField="DesHor" HeaderText="Descrição do Horário" SortExpression="DesHor"
                                                                    UniqueName="DesHor">
                                                                    <ItemStyle Width="50%"></ItemStyle>
                                                                    <HeaderStyle HorizontalAlign="Left" />
                                                                </rad:GridBoundColumn>
                                                                 <rad:GridTemplateColumn UniqueName="TemplateColumn" Visible="False">
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <asp:ImageButton ID="btnEditar" runat="server" AlternateText="Editar" CausesValidation="False"
                                                                            CommandArgument='<%# DataBinder.Eval(Container.DataItem, "CodHor") %>' CommandName="Editar"
                                                                            ImageUrl="%%PATH%%/imagens/icones/ico_editar.gif" ToolTip="Editar"></asp:ImageButton>
                                                                    </ItemTemplate>
                                                                </rad:GridTemplateColumn>
                                                            </Columns>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="760" align="center">
                                            <tr>
                                                <td align="right" class="backBarraBotoes" style="height: 31px"> 
                                                    ...
                                                    &nbsp;
                                                <asp:Button ID="btnGravar" runat="server" CssClass="cadbutton100" Text="Salvar" OnClick="btnGravar_Click" ValidationGroup="Cadastro" />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>                
