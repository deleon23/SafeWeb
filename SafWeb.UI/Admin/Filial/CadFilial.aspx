                                    ...
                                    <table class="MarginTopConteudo" cellspacing="0" cellpadding="0" width="740" align="center"
                                        ...
                                        <tr>
                                            <td style="height: 19px; width: 230px;">
                                                <asp:DropDownList ID="ddlRegionalList" runat="server" CssClass="cadddl" AutoPostBack="true"
                                                    Width="150px" OnSelectedIndexChanged="ddlRegionalList_SelectedIndexChanged" Enabled="true">
                                                </asp:DropDownList>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="cadlbl" colspan="2">
                                                <asp:TextBox ID="txtDescricaoList" runat="server" MaxLength="50" Width="382px" CssClass="cadtxt" />
                                            </td>
                                        </tr>
                                        <!--
                                            <tr>
                                            ...
                                            <td align="center" colspan="3">
                                                ...
                                                <rad:RadGrid ID="radGridFilial" runat="server" AllowPaging="True" AllowSorting="True"
                                                    ...
                                                    <MasterTableView>
                                                        ...
                                                        <Columns>
                                                            <rad:GridBoundColumn DataField="Id_Filial" SortExpression="Id_Filial" UniqueName="Id_Filial"
                                                                Visible="false">
                    ...
                    <asp:Panel runat="server" ID="pnlCadastro" Visible="false">
                        ...
                        <table class="MarginTopBarra" cellspacing="0" cellpadding="0" width="760" align="center"
                                            ...
                                            <table width="740" cellspacing="0" cellpadding="0" align="center">
                                                <tr>
                                                    <td class="cadmsg" colspan="2">
                                                        ...
                                                        <asp:Label ID="lblMensagem" runat="server" Visible="false" Text="Label" CssClass="cadlbl"></asp:Label>
                                                    </td>
                                                    <td class="cadmsg">
                                                        &nbsp;
                                                    </td>
                                                ...
                                                <tr>
                                                    <td class="cadlbl">
                                                        <asp:DropDownList ID="ddlRegionalCad" runat="server" CssClass="cadddl" AutoPostBack="false"
                                                            Width="150px" OnSelectedIndexChanged="ddlRegionalCad_SelectedIndexChanged" Enabled="true">
                                                        </asp:DropDownList>
                                                    ...
                                                    <td class="cadlbl">
                                                        <asp:TextBox ID="txtSiglaFilial" runat="server" MaxLength="50" Width="150px" CssClass="cadtxt" />
                                                    ...
                                                    <td width="250px" style="height: 19px">
                                                        <asp:TextBox ID="txtFilial" runat="server" MaxLength="50" Width="150px" CssClass="cadtxt" />
                            ...
                            <tr>
                                <td class="cadlblcadlbl">
                                    <asp:DropDownList ID="ddlEstado" runat="server" CssClass="cadddl" AutoPostBack="true"
                                        Width="150px" OnSelectedIndexChanged="ddlEstado_SelectedIndexChanged" Enabled="true">
                                    </asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="rfvEstado" runat="server" ControlToValidate="ddlEstado"
                                        ErrorMessage="Campo Obrigatório: Estado." InitialValue="0" SetFocusOnError="True">*</asp:RequiredFieldValidator>
                                </td>
                                <td class="cadlbl">
                                    <asp:DropDownList ID="ddlCidade" runat="server" CssClass="cadddl" AutoPostBack="false"
                                        Width="150px" Enabled="false">
                                    </asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="rfvCidade" runat="server" ControlToValidate="ddlCidade"
                                        ErrorMessage="Campo Obrigatório: Cidade." InitialValue="0" SetFocusOnError="True">*</asp:RequiredFieldValidator>
                                </td>
                                <td class="cadlbl" width="200px">
                                    <asp:DropDownList ID="ddlFusoHorario" runat="server" CssClass="cadddl" AutoPostBack="false"
                                        Width="150px" Enabled="true" Height="16px">
                                    </asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="rfvFusoHorario" runat="server" ControlToValidate="ddlFusoHorario"
                                        ErrorMessage="Campo Obrigatório: Fuso Horário." InitialValue="0" SetFocusOnError="True">*</asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td class="cadlbl">
                            ...
                            <tr>
                                ...
                                <td class="cadlbl">
                                    <asp:CheckBox ID="chkPortariaValAcesso" runat="server" Text="Portaria valida acesso?"
                                        Width="188px" CssClass="cadchk" />
                                </td>
                            </tr>
                            <tr>
                                <td class="cadlbl">
                                    <asp:TextBox ID="txtCodigoFilialCorporate" runat="server" CssClass="cadddl" AutoPostBack="false"
                                        Width="149px" Enabled="true" />
                                ...
                                <td class="cadlbl">
                                    <asp:TextBox ID="txtQtdToleranciaAcesso" runat="server" CssClass="cadddl" AutoPostBack="false"
                                        Width="149px" Enabled="true" />
                                ...
                                <td width="250px" style="height: 19px">
                                    <asp:CheckBox ID="chkColetorOnline" runat="server" CssClass="cadchk" Text="Possui coletores de acesso online?"
                                        Width="231px" Enabled="true" Height="16px" />
                                </td>
                            </tr>
                            <tr>
                                <td class="cadlbl">
                        ...
                        <asp:Panel ID="pnlPerfilAcesso" runat="server">
                            ...
                            <table width="740" cellspacing="0" cellpadding="0" align="center" style="border: 1px solid black">
                                ...
                                <tr>
                                    <td class="cadlbl" style="padding-top: 20px;">
                                    ...
                                    <td class="cadlbl" style="padding-top: 20px;">
                                        <asp:Label ID="lblAreaTI" runat="server" Text=""></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="height: 19px">
                                        <asp:TextBox ID="txtDes_Area" runat="server" MaxLength="50" Width="150px" CssClass="cadtxt" />
                                        <asp:RequiredFieldValidator ID="rfvDes_Area" runat="server" ControlToValidate="txtDes_Area"
                                            ValidationGroup="GrupoColetor" ErrorMessage="Campo Obrigatório: Descrição da Área."
                                            SetFocusOnError="True">*</asp:RequiredFieldValidator>
                                    </td>
                                    <td style="height: 19px">
                                        <asp:CheckBox ID="chkAreaSeg" runat="server" Text="Área de Segurança" Width="188px"
                                            CssClass="cadchk" />
                                    </td>
                                    <td style="height: 19px">
                                        <asp:CheckBox ID="chkAreaTI" runat="server" Text="Área de TI" Width="188px" CssClass="cadchk" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="cadlbl">
                                    ...
                                    <td class="cadlbl">
                                        <asp:Label ID="lblGrupoPonto" runat="server" Text=""></asp:Label>
                                    </td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td style="height: 19px">
                                        <asp:DropDownList ID="ddlGrupoColetores" runat="server" CssClass="cadddl" AutoPostBack="false"
                                            Width="150px" Enabled="true">
                                        </asp:DropDownList>
                                        <%--<asp:RequiredFieldValidator ID="rfvGrupoColetores" runat="server" ControlToValidate="ddlGrupoColetores"
                                            ValidationGroup="GrupoColetor" ErrorMessage="Campo Obrigatório: Grupo de Coletores."
                                            InitialValue="0" SetFocusOnError="True">*</asp:RequiredFieldValidator>--%>
                                    </td>
                                    <td style="height: 19px;">
                                        <asp:CheckBox ID="chkColetoresPonto" runat="server" Text="Marcação de Ponto" Width="188px"
                                            CssClass="cadchk" />
                                    ...
                                    <td align="center" colspan="3">
                                        ...
                                        <rad:RadGrid ID="radGridPerfilAcesso" runat="server" AllowPaging="True" AllowSorting="True"
                                            ...
                                            <MasterTableView>
                                                ...
                                                <Columns>
                                                    <rad:GridBoundColumn DataField="Codigo" SortExpression="Codigo" UniqueName="Codigo"
                                                        Visible="false">
                                                        <ItemStyle Width="5%"></ItemStyle>
                                                    </rad:GridBoundColumn>
                                                    ...
                                                    <rad:GridBoundColumn DataField="Flg_AreaTI" HeaderText="Área de TI" SortExpression="Flg_AreaTI"
                                                        UniqueName="Flg_AreaTI">
                                                        <ItemStyle Width="10%"></ItemStyle>
                                                    </rad:GridBoundColumn>

                                                    <rad:GridBoundColumn DataField="flg_ColetoresPonto" HeaderText="Marcação de Ponto" SortExpression="flg_ColetoresPonto"
                                                        UniqueName="flg_ColetoresPonto">
                                                        <ItemStyle Width="10%"></ItemStyle>
                                                    </rad:GridBoundColumn>

                                                    <rad:GridBoundColumn DataField="Des_GrupoColetores" HeaderText="Grupo de Coletores"
                                                        SortExpression="Des_GrupoColetores" UniqueName="Des_GrupoColetores">
                                                        <ItemStyle Width="20%" HorizontalAlign="Center"></ItemStyle>
                                                    </rad:GridBoundColumn>
                                                    ...
                                                    <rad:GridTemplateColumn UniqueName="TemplateColumn" Visible="False">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:ImageButton ID="btnEditar" runat="server" AlternateText="Editar" CausesValidation="False"
                                                                CommandArgument='<%# DataBinder.Eval(Container.DataItem, "Codigo") %>' CommandName="Editar"
                                                                ImageUrl="%%PATH%%/imagens/icones/ico_editar.gif" ToolTip="Editar"></asp:ImageButton>
                                                        </ItemTemplate>
                                                    </rad:GridTemplateColumn>
                                                    <rad:GridButtonColumn CommandName="Ativar" UniqueName="Ativar" ButtonType="ImageButton"
