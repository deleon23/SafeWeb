<%@ Page Language="C#" AutoEventWireup="true" Codebehind="ListVisitados.aspx.cs"
...
<head>
    ...
    <script language="javascript">
        ...
        function returnToParent(codigo)
        {
             //create the argument that will be returned to the parent page
             //var oArg = new Object();
            
            //get the city's name 
            //oArg.idColaborador = codigo;
            
            //alert(oArg.idColaborador);
            
            //var oWindow = GetRadWindow();
            //oWindow.Close(codigo); 
            
            //alert(parent.document.);,
            //window.parent.opener.document.form.txtDocumento.value = codigo;
            
            //window.close();
            
            //GetRadWindow().BrowserWindow.location.txtNomeVisitante.value = oArg.idColaborador;
                                ...
                                <rad:GridTemplateColumn UniqueName="TemplateColumn" Visible="false">
                                    ...
                                    <ItemTemplate>
                                        <asp:ImageButton ID="btnEditar" runat="server" AlternateText="Editar" CausesValidation="False"
                                            CommandArgument='<%# DataBinder.Eval(Container.DataItem, "IdColaborador") %>' CommandName="Editar"
