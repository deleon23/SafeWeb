<%@ Page Language="C#" AutoEventWireup="true" Codebehind="RelEntrada.aspx.cs" Inherits="SafWeb.UI.Modulos.Relatorio.RelEntrada" %>
                            ...
                            <table class="MarginTopBarra" cellspacing="0" cellpadding="0" width="760" align="center"
                                ...
                                <tr>
                                    <td class="cadBarraTitulo" align="left" height="25" style="width: 750px">
                                        ...
                                        <asp:Label ID="lblListagem" runat="server" Text="Entradas"></asp:Label>
                                    </td>
                                ...
                                <tr>
                                    <td class="backboxconteudo" valign="top" colspan="2">
                                        ...
                                        <table class="MarginTopConteudo" cellspacing="0" cellpadding="0" width="740" align="center"
                                            ...
                                            <tr>
                                                <td class="cadlbl" width="180" style="height: 19px">
                                            ...
                                            <tr>
                                                ...
                                                <td class="cadlbl">
                                                    <asp:Label ID="lblCracha" runat="server" Text="Cracha:"></asp:Label></td>
                                                <td>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <cc1:FWMascara ID="txtCracha" runat="server" AutoPostBack="True" CssClass="cadtxt"
                                                        Mascara="NUMERO" MaxLength="10" Width="99px"></cc1:FWMascara></td>
                                                <td>
                                                </td>
                                                <td>
                                                    ...
                                                    <a hidefocus onclick="if(self.gfPop)gfPop.fPopCalendar(document.forms[0].all('<% = this.txtDataInicio.ClientID.ToString() %>'));return false;"
                                                        ...
                                                        <img height="19" alt="" src="../../Agenda/calbtn.gif" width="20" align="absMiddle"
                                                            border="0" name="popcal"></a><asp:RequiredFieldValidator ID="rfvDataInicio" runat="server"
                                                                ControlToValidate="txtDataInicio" ErrorMessage="Campo Data Início é obrigatório."
                                                ...
                                                <td>
                                                    ...
                                                    <asp:CompareValidator ID="cpvDataFim" runat="server" ControlToCompare="txtDataInicio"
                                                        ControlToValidate="txtDataFim" ErrorMessage="A Data Fim deve ser maior que a Data Início"
                                            ...
                                            <tr>
                                                ...
                                                <td class="cadlbl" colspan="3">
                                                    <asp:Label ID="lblVisitante" runat="server" Text="Visitante:"></asp:Label></td>
                                                <td>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="3">
                                                    <asp:TextBox ID="txtVisitado" runat="server" CssClass="cadtxt" MaxLength="50" Width="340px"></asp:TextBox></td>
                                                <td>
                                                </td>
                                                <td colspan="3">
                                                    <asp:TextBox ID="txtVisitante" runat="server" CssClass="cadtxt" MaxLength="50" Width="335px"></asp:TextBox></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td style="height: 19px">
                                                    <asp:DropDownList ID="ddlEstado" CssClass="cadddl" runat="server" Width="150px" AutoPostBack="True"
                                                        OnSelectedIndexChanged="ddlEstado_SelectedIndexChanged">
                                                    </asp:DropDownList></td>
                                                <td style="height: 19px">
                                                </td>
                                                <td style="height: 19px">
                                                    <asp:DropDownList ID="ddlPlaca" CssClass="cadddl" runat="server" Width="150px" AutoPostBack="True"
                                                        OnSelectedIndexChanged="ddlRegional_SelectedIndexChanged" Enabled="False">
                                                    </asp:DropDownList></td>
                                                <td style="height: 19px">
                                                </td>
                                                <td style="height: 19px">
                                                    ...
                                                    <rad:RadGrid ID="radGridRelatorio" runat="server" AllowPaging="True" AllowSorting="True"
                                                        ...
                                                        <MasterTableView>
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <rad:GridBoundColumn DataField="DataSaida" HeaderText="Data/Hora Saída" SortExpression="DataSaida"
                                                                ...
                                                                <rad:GridBoundColumn DataField="Cracha" HeaderText="Crachá" SortExpression="Cracha"
                                                                    UniqueName="Cracha">
                                                                    <ItemStyle Width="10%" HorizontalAlign="Center"></ItemStyle>
                                                                </rad:GridBoundColumn>
                                                                <rad:GridBoundColumn DataField="Veiculo" HeaderText="Veiculo" SortExpression="Veiculo"
                                                                    UniqueName="Veiculo">
                                                                    <ItemStyle Width="10%" HorizontalAlign="Center"></ItemStyle>
                                                                </rad:GridBoundColumn>
                                                            </Columns>
