        ...
        <table class="MarginTopConteudo" cellspacing="0" cellpadding="0" width="500px" border="0">
            <tr>
                <td style="width: 169px; height: 21px;">
                    <asp:Label ID="lblFilialList" runat="server" Text="Filial:" CssClass="cadlbl" ></asp:Label>
                </td> 
                <td style="width: 169px; height: 21px;">
                    <asp:Label ID="lblDocumento" runat="server" CssClass="cadlbl" Text="Documento:"></asp:Label>
                </td> 
            ...
            <tr>
                <td  style="height: 21px">
                    <asp:DropDownList ID="ddlFilial" runat="server" CssClass="cadddl" Width="150px">
                    </asp:DropDownList>
                </td>
                <td style="height: 21px">
