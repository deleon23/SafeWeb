<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportarEscalaCrewVisualizar.aspx.cs"
    Inherits="SafWeb.UI.Modulos.Escala.ImportarEscalaCrewVisualizar" %>
                    ...
                    <table class="MarginTopBarra" cellspacing="0" cellpadding="0" width="760" align="center"
                        ...
                        <tr>
                            <td class="cadBarraTitulo" align="left" style="height: 25px; width: 750px">
                                ...
                                <asp:Label ID="Label2" runat="server" Text="Visualizar Escala / Troca de horário CREW"></asp:Label>
                            </td>
                                    ...
                                    <tr>
                                        <td style="padding-top: 10px; padding-bottom: 20px;">
                                            <table class="MarginTopConteudo" cellspacing="0" cellpadding="0" width="740" align="center"
                                                border="0">
                                                <tr>
                                                    <td class="cadlbl" align="right" colspan="2" style="padding-top: 20px;" width="100px">
                                                        <asp:Label ID="lblNomeColaborador" runat="server" Text="Colaborador:"></asp:Label>
                                                    </td>
                                                    
                                                    <td class="cadlbl" align="right" colspan="2" style="padding-top: 20px;" width="520px">
                                                        <asp:Label ID="lblDataBusca" runat="server" Text="Período:"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td width="100px" align="left" colspan="2" style="padding-bottom: 10px;">
                                                        <asp:TextBox ID="txtNomeColaborador" runat="server" CssClass="cadddl" Width="150px">
                                                        </asp:TextBox>
                                                    </td>
                                                    <td width="520px" align="left" colspan="2" style="padding-bottom: 10px;">
                                                        <asp:DropDownList ID="ddlDatas" runat="server" CssClass="cadddl" Width="150px">
                                                        </asp:DropDownList>
                                                        &nbsp;&nbsp;&nbsp;<asp:Button ID="btnFiltrarData" runat="server" CssClass="cadbutton100"
                                                            Text="Filtrar" OnClick="btnFiltrarData_Click" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="cadlbl" width="520" align="left" style="width: 260px">
                                                        ...
                                                        <asp:CheckBox  style="padding-left: 15px;" ToolTip="Feriado (hora extra)" ID="chkHoraExtra" runat="server" Height="20px" Width="150px"
                                                            SelectionMode="Single" CssClass="cadchk" Font-Bold="true"
                                                            ForeColor="DarkRed" Visible="true" Text="Feriado"></asp:CheckBox>                                                        
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td width="220px">
