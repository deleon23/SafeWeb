                                                                ...
                                                                <table cellspacing="2" cellpadding="2" width="100%" align="center" border="0">
                                                                    <tr>
                                                                        <td class="cadlbl">
                                                                            ...
                                                                            <asp:RequiredFieldValidator ID="rfvNome" runat="server" CssClass="nomecampos" ErrorMessage="- Campo Obrigatório: Nome"
                                                                    ...
                                                                    <tr>
                                                                        <td class="cadlbl">
                                                                            ...
                                                                            <asp:RequiredFieldValidator ID="rfvSuperGrupo" runat="server" CssClass="nomecampos"
                                                                                ErrorMessage="- Seleção Obrigatória: Super Grupo" Display="Dynamic" ControlToValidate="ddlSuperGrupoCadastro"
                                                                ...
                                                                <table cellspacing="2" cellpadding="2" border="0">
                                                                    <tr>
                                                                        <td class="cadlbl" width="150">
                                                                            <asp:Label ID="lblUsuarios" runat="server">Usuário:</asp:Label></td>
                                                                        <td>
                                                                        </td>
                                                                        <td class="cadlbl">
                                                                            <asp:Label ID="lblUsuariosSelecionados" runat="server">Usuários Selecionados:</asp:Label></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
