...
var _f=["DockStateChanged","Dock","UnDock","DragStart","Drag","Drop","DragEnd","ResizeStart","ResizeEnd"];
...
},OnResizeStart:function(_6b,_6c){
if(this.clientEventHandlers["OnResizeStart"]){
eval(this.clientEventHandlers["OnResizeStart"])(_6b,_6c);
}
},OnResizeEnd:function(_6d,_6e){
if(this.clientEventHandlers["OnResizeEnd"]){
eval(this.clientEventHandlers["OnResizeEnd"])(_6d,_6e);
}
...
if(_5.FireEvent&&"move"==RadDockNamespace.RadDock_Action){
...
RadDockNamespace.RadDockingManager.prototype.InitDragHelper=function(_d,_e){
var _f=document.getElementById(_d);
if(_f){
RadDockNamespace.InitMoveableObject(_f);
if(document.all){
_f.style.filter="progid:DXImageTransform.Microsoft.Alpha(opacity=25)";
}else{
_f.style.setProperty("-moz-opacity","0.25","");
}
}
this.DragHelper=_f;
var _10=document.getElementById(_e);
if(_10){
RadDockNamespace.RadTooltip_Init(_10);
}
this.DragHelperTooltip=_10;
};
RadDockNamespace.RadDockingManager.prototype.RegisterDockingZones=function(_11){
for(var i=0;i<_11.length;i++){
this.RegisterDockingZone(_11[i]);
}
};
...
RadDockNamespace.RadDockingManager.prototype.RegisterDockableObjects=function(_14){
for(var i=0;i<_14.length;i++){
this.RegisterDockableObject(_14[i]);
}
};
RadDockNamespace.RadDockingManager.prototype.RegisterDockingZone=function(_16){
if(!_16||!_16.length){
return;
}
var id=_16[0];
var _18=this.Document.getElementById(id);
if(!_18){
return;
}
RadDockNamespace.RadDockingZone_Init(_18,_16.slice(1));
_18.Manager=this;
var _19=this.zoneIndexTable[_18.id];
if(null==_19){
_19=this.DockingZones.length;
}
this.DockingZones[_19]=_18;
this.zoneIndexTable[_18.id]=_19;
};
RadDockNamespace.RadDockingManager.prototype.RegisterDockableObject=function(_1a){
if(!_1a||!_1a.length){
return;
}
var id=_1a[0];
var _1c=this.Document.getElementById(id);
if(!_1c){
return;
}
RadDockNamespace.InitDockableObject(_1c,_1a.slice(1));
_1c.Manager=this;
var _1d=this.objectIndexTable[_1c.id];
if(null==_1d){
_1d=this.DockableObjects.length;
}
this.DockableObjects[_1d]=_1c;
this.objectIndexTable[_1c.id]=_1d;
this.SaveDockingZonesState();
};
RadDockNamespace.RadDockingManager.prototype.EnableDocking=function(_1e){
this.DockEnabled=_1e;
if(this.DockEnabled){
...
RadDockNamespace.RadDockingManager.prototype.DockingZoneHitTest=function(_1f,_20,_21){
var _22;
var _23;
for(var i=0;i<this.DockingZones.length;i++){
_22=this.DockingZones[i];
if(_22.HitTest(_1f,_20,_21)){
_23=_22;
}
}
for(var i=0;i<this.DockingZones.length;i++){
_22=this.DockingZones[i];
_22.Highlight(_22==_23);
}
return _23;
};
